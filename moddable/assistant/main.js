...
const styles = [
  ...
  rightStyle,
  justifyStyle,
  absoluteLeadingStyle,
  relativeLeadingStyle,
];
      ...
      blocks: [
          ...
          spans: [
            {
              style: redStyle,
              spans: "Lorem ipsum",
              link: Link("tutu", { Behavior: LinkBehavior }),
            },
            " おはよ！",
            {
              style: otherStyle,
              spans: "Nulla",
              link: Link("toto", { Behavior: LinkBehavior }),
            },
        ...
        },
        {
          spans: [
            ...
            {
              style: redStyle,
              link: Link("titi", { Behavior: LinkBehavior }),
              spans: [
                " molestie. ",
  ...
  Behavior: class extends Behavior {
    onDisplaying(application) {
      if (application.height != 240 || application.width != 320)
        trace(
          "WARNING: This application was designed to run on a 320x240 screen.\n",
        );
    }
  },
}));
